...
run("Analyze Particles...", "size=1.00-Infinity circularity=0.05-1.00 exclude clear add slice"); //analyse particles based on being >5mm and at least mostly circular.

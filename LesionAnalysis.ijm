...
run("Analyze Particles...", "size=5.00-Infinity circularity=0.10-1.00 exclude clear add slice"); //analyse particles based on being >5mm and at least mostly circular.

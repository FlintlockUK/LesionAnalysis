...
//PhotoName = PhotoFile.substring(0, PhotoFile.lastIndexOf('.')); //name of photo (no file extension)
PhotoDuplicate = PhotoFile+"-1.JPG"; //filename of photo duplicate
...
run("Analyze Particles...", "size=10.00-Infinity circularity=0.20-1.00 exclude clear add slice"); //analyse particles based on being >10mm and at least mostly circular.
